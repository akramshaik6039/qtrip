...
class Bancourosel  extends React.Component {
    constructor(props) {
        super(props)
    }
    render() {
        return (
            ...
            <div className="maincour">
                ...
                <Carousel>
                    ...
                    <img className="courimg" src="https://images.pexels.com/photos/66997/pexels-photo-66997.jpeg?auto=compress&cs=tinysrgb&h=650&w=940"/>
                    
                    <img className="courimg" src="https://images.pexels.com/photos/837745/pexels-photo-837745.jpeg?auto=compress&cs=tinysrgb&h=650&w=940"/>
                    
                    <img className="courimg" src="https://images.pexels.com/photos/1624438/pexels-photo-1624438.jpeg?auto=compress&cs=tinysrgb&h=650&w=940"/>
